...
public class HorariosAdapter extends RecyclerView.Adapter<HorariosAdapter.ARV> implements Filterable {
    private List<Horario> eventosList;
    private List<Horario> eventosListFull;

    private OnVisitanteClickListener mListener;

    public HorariosAdapter(List<Horario> eventosList) {
    ...
    public ARV onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ARV(LayoutInflater.from(parent.getContext()).inflate(R.layout.horarios_list, parent, false));
    }
    ...
    private Filter exampleFilter = new Filter() {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            List<Horario> filteredList = new ArrayList<>();
            ...
            else
            {
                ...
                for (Horario item : eventosListFull)
                {
                    if(item.getHorNombre().toLowerCase().contains(filterPattern))
                    {
    ...
    public class ARV extends RecyclerView.ViewHolder implements View.OnClickListener
    {
        ...
        public void onClick(View view)
        {
            ...
            mListener.onEventoClick(horario);
    ...
    {
        void onEventoClick(Horario horario);
    }
}
