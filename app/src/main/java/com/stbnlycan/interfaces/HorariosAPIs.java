...
public interface HorariosAPIs {
    ...
    */
    ...
    Call <List<Horario>> listaHorarios(@Query("recCod") String recCod, @Query("tviCod") String tviCod, @Query("horNombre") String horNombre, @Query("dia") String dia, @Header("Authorization") String authHeader);
}
