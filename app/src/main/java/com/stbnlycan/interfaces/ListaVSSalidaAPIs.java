...
public interface ListaVSSalidaAPIs {
    ...
    @GET("visita/visitantesSinSalida")
    Call<ListaVisitas> listaVSSalida(@Query("fechaInicio") String fechaInicio, @Query("fechaFin") String fechaFin, @Query("recinto") String recinto, @Query("areaRecinto") String areaRecinto, @Query("page") String page, @Query("size") String size);
}
