...
public class VCSalidaActivity extends AppCompatActivity implements VisitasAdapter.OnVisitanteClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Visitantes con salidas pendientes");
    ...
    private void fetchVisitas() {
        ...
        ListaVCSalidaAPIs listaVCSalidaAPIs = retrofit.create(ListaVCSalidaAPIs.class);
        Call<List<Visita>> call = listaVCSalidaAPIs.listaVCSalida("23-07-2020", "23-08-2020", recintoRecibido.getRecCod(), "2");
